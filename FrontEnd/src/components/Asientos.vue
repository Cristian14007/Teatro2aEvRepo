...
<h1 class="heading"> Reservar <span>Asientos</span> </h1>
...
.container .confirmCont .rightBottomCont .selectedSeatCont .selectedSeatsHolder {
  display: grid;
...
.container .confirmCont .rightBottomCont .buttonCont .proceedBtnEl button:hover {
